        ...
        return this.clean = function() {
            ...
            return e.each(function() {
                var i = o(this),
                    c = o(this).data("type"),
                    s = o("<div />", {
                        class: "select_box_" + c + " select_box " + i.attr("name")
                    }).insertAfter(i);
                i.removeData("last_content"), i.find("option").each(function() {
                    if (o(this).data("value")) {
                        var t = "select_option_" + c + " select_option",
                            e = o(this).data("value"),
                            n = o(this),
                            a = o("<div/>", {
                                class: t
                            }).data("value", o(this).attr("value")).data("option", n.clone(!0)).appendTo(s).off("click").on("click", function(t) {
                                o(this).hasClass("selected") ? i.val("").change() : (t.preventDefault(), i.val(n.val()).change())
                            });
                        "colorpicker" == c ? a.append(o("<span/>", {
                            css: {
                                background: e
                            }
                        })) : "image" == c ? a.append(o("<img/>", {
                            src: e
                        })) : "label" == c && a.append(o("<span/>", {
                            text: e
                        }))
                    }
                })
            }).filter(function() {
                return "select" != o(this).data("type")
            }).hide(), t
        }, this.onSelect = function() {
            return e.each(function() {
                var t = o(this).val(),
                    e = o(this).next(".select_box");
                e.length || (e = o(this).siblings(".select_box")), e = e.find(".select_option").removeClass("selected"), t && e.filter(function() {
                    return o(this).data("value") == t
                }).addClass("selected")
            }), t
